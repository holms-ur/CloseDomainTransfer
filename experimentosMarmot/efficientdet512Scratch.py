...
model = efficientdet.model(model_name='tf_efficientdet_d2', pretrained=False,num_classes=len(class_map),img_size=size)
...
saveM=SaveModelMAP(monitor='COCOMetric',fname='model-ice-efficientdetMarmotScratch-v1')
...
learn.save('ice-efficientdetMarmotScratch-v1')
