...
model = efficientdet.model(model_name='tf_efficientdet_d3', num_classes=len(class_map),img_size=size)
...
saveM=SaveModelMAP(monitor='COCOMetric',fname='model-ice-efficientdet-v1')
...
learn.save('ice-efficientdet-v1')
