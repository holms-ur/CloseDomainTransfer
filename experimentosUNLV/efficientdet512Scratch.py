...
saveM=SaveModelMAP(monitor='COCOMetric',fname='model-ice-efficientdetUNLVScratch-v1')
lrReduce=ReduceLRMAP(monitor='COCOMetric',patience=3, factor=10.0, min_lr=0)
early=EarlyStoppingMAP(monitor='COCOMetric',patience=8)
...
learn.save('ice-efficientdetUNLVScratch-v1')
